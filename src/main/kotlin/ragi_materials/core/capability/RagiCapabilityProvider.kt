...
class RagiCapabilityProvider<T : Any?>(private val capability: Capability<T>, private val instance: T, private var serializer: INBTSerializable<NBTTagCompound>) : ICapabilitySerializable<NBTTagCompound> {
