...
object PeriodSeventh {
    ...
    fun load() {
        //900 ~ 909: Thorium
        MaterialRegistry.THORIUM = RagiMaterial.Builder(900, "thorium", TypeRegistry.METAL.enableRadio()).setSimple(ElementRegistry.THORIUM to 1).build()

        //920 ~ 929: Uranium
        MaterialRegistry.URANIUM_238 = RagiMaterial.Builder(920, "uranium", TypeRegistry.METAL.enableRadio()).setSimple(ElementRegistry.URANIUM_238 to 1).build()
