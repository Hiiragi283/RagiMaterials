...
object PeriodFourth {
    ...
    fun load() {
        ...
        MaterialRegistry.LIME = RagiMaterial.Builder(202, "lime", TypeRegistry.DUST.enableOre()).setComponents(listOf(ElementRegistry.CALCIUM to 1, MaterialRegistry.CARBONATE to 1)).buildAndRegister()
        ...
        //260 ~ 269: Iron
        MaterialRegistry.IRON = RagiMaterial.Builder(260, "iron", TypeRegistry.METAL).setSimple(ElementRegistry.IRON to 1).buildAndRegister()
        ...
        //290 ~ 299: Copper
        MaterialRegistry.COPPER = RagiMaterial.Builder(290, "copper", TypeRegistry.METAL.enableOre()).setSimple(ElementRegistry.COPPER to 1).buildAndRegister()
        MaterialRegistry.COPPER.setSubMaterial(EnumSubMaterial.NATIVE, MaterialRegistry.COPPER)

        //300 ~ 309: Zinc
        MaterialRegistry.ZINC = RagiMaterial.Builder(300, "zinc", TypeRegistry.METAL.enableOre()).setSimple(ElementRegistry.ZINC to 1).buildAndRegister()
