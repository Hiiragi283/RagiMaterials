...
object ElementRegistry {
    ...
    val CARBON = RagiMaterial.Element("carbon", TypeRegistry.METALLOID, ColorUtil.mixColor(RagiColor.BLACK, RagiColor.DARK_GRAY), 12.0f, "C", tempSubl = 4400).build()
    ...
    val MAGNESIUM = RagiMaterial.Element("magnesium", TypeRegistry.METAL, ColorUtil.mixColor(RagiColor.LIGHT_PURPLE, RagiColor.WHITE), 24.3f, "Mg", 650, 1090).build()

    val ALUMINIUM = RagiMaterial.Element("aluminium", TypeRegistry.METAL, ColorUtil.mixColor(RagiColor.AQUA, RagiColor.WHITE), 27.0f, "Al", 660, 2519).build()
    ...
    val SULFUR = RagiMaterial.Element("sulfur", TypeRegistry.DUST, ColorUtil.mixColor(RagiColor.GOLD, RagiColor.YELLOW), 32.1f, "S", 120, 445).build()
    ...
    val TITANIUM = RagiMaterial.Element("titanium", TypeRegistry.METAL, ColorUtil.mixColor(RagiColor.GOLD to 1, RagiColor.WHITE to 2), 47.9f, "Ti", 1668, 3287).build()

    val CHROMIUM = RagiMaterial.Element("chromium", TypeRegistry.METAL, RagiColor.GREEN, 52.0f, "Cr", 1907, 2671).build()

    val MANGANESE = RagiMaterial.Element("manganese", TypeRegistry.METAL, ColorUtil.mixColor(RagiColor.RED, RagiColor.WHITE), 54.9f, "Mn", 1246, 2061).build()
    ...
    val NICKEL = RagiMaterial.Element("nickel", TypeRegistry.METAL, ColorUtil.mixColor(RagiColor.GOLD, RagiColor.WHITE), 58.7f, "Ni", 1455, 2913).build()

    val COPPER = RagiMaterial.Element("copper", TypeRegistry.METAL, ColorUtil.mixColor(RagiColor.GOLD, RagiColor.RED), 63.5f, "Cu", 1085, 2562).build()
    ...
    val ARSENIC = RagiMaterial.Element("arsenic", TypeRegistry.METALLOID, RagiColor.DARK_GRAY, 74.9f, "As", tempSubl = 603).build()

    //5th Period
    val STRONTIUM = RagiMaterial.Element("strontium", TypeRegistry.INTERNAL, RagiColor.WHITE, 87.6f, "Sr", 777, 1377).build()

    val ZIRCONIUM = RagiMaterial.Element("zirconium", TypeRegistry.METAL, ColorUtil.mixColor(RagiColor.BLUE, RagiColor.LIGHT_PURPLE), 91.2f, "Zr", 1855, 4409).build()

    val NIOBIUM = RagiMaterial.Element("niobium", TypeRegistry.METAL, ColorUtil.mixColor(RagiColor.DARK_BLUE, RagiColor.WHITE), 92.9f, "Nb", 2477, 4744).build()

    val MOLYBDENUM = RagiMaterial.Element("molybdenum", TypeRegistry.METAL, ColorUtil.mixColor(RagiColor.DARK_BLUE, RagiColor.WHITE), 96.0f, "Mo", 2023, 4639).build()

    val RUTHENIUM = RagiMaterial.Element("ruthenium", TypeRegistry.METAL, ColorUtil.mixColor(RagiColor.LIGHT_PURPLE to 1, RagiColor.WHITE to 3), 101.1f, "Ru", 2334, 4150).build()

    val RHODIUM = RagiMaterial.Element("rhodium", TypeRegistry.METAL, ColorUtil.mixColor(RagiColor.RED to 1, RagiColor.WHITE to 3), 102.9f, "Rh", 1964, 3695).build()

    val PALLADIUM = RagiMaterial.Element("palladium", TypeRegistry.METAL, ColorUtil.mixColor(RagiColor.YELLOW to 1, RagiColor.WHITE to 3), 106.4f, "Pa", 1555, 2963).build()

    val SILVER = RagiMaterial.Element("silver", TypeRegistry.METAL, ColorUtil.mixColor(RagiColor.AQUA to 1, RagiColor.WHITE to 2), 107.9f, "Ag", 962, 2162).build()

    val INDIUM = RagiMaterial.Element("indium", TypeRegistry.METAL, ColorUtil.mixColor(RagiColor.DARK_BLUE, RagiColor.RED), 114.8f, "In", 157, 2072).build()
    ...
    val IODINE = RagiMaterial.Element("iodine", TypeRegistry.DUST, ColorUtil.mixColor(RagiColor.DARK_BLUE, RagiColor.DARK_RED), 126.9f, "I", 114, 184).build()
    ...
    val TUNGSTEN = RagiMaterial.Element("tungsten", TypeRegistry.METAL, ColorUtil.mixColor(RagiColor.BLACK, RagiColor.DARK_GRAY), 183.8f, "W", 3422, 5555).build()

    val OSMIUM = RagiMaterial.Element("osmium", TypeRegistry.METAL, ColorUtil.mixColor(RagiColor.BLUE to 1, RagiColor.WHITE to 3), 190.2f, "Os", 3033, 5012).build()

    val IRIDIUM = RagiMaterial.Element("iridium", TypeRegistry.METAL, ColorUtil.mixColor(RagiColor.AQUA to 1, RagiColor.WHITE to 3), 192.2f, "Ir", 2446, 4428).build()

    val PLATINUM = RagiMaterial.Element("platinum", TypeRegistry.METAL, ColorUtil.mixColor(RagiColor.GREEN to 1, RagiColor.WHITE to 3), 195.1f, "Pt", 1768, 3825).build()
    ...
    val LEAD = RagiMaterial.Element("lead", TypeRegistry.METAL, ColorUtil.mixColor(RagiColor.DARK_BLUE, RagiColor.DARK_GRAY, RagiColor.WHITE), 207.2f, "Pb", 327, 1749).build()

    val BISMUTH = RagiMaterial.Element("bismuth", TypeRegistry.METAL, RagiColor.DARK_AQUA, 209.0f, "Bi", 271, 1564).build()

    //7th Period
    val THORIUM = RagiMaterial.Element("thorium", TypeRegistry.METAL.enableRadio(), ColorUtil.mixColor(RagiColor.BLACK, RagiColor.DARK_GREEN), 232.0f, "Th", 1750, 4788).build()

    val URANIUM_238 = RagiMaterial.Element("uranium", TypeRegistry.METAL.enableRadio(), RagiColor.GREEN, 238.0f, "U", 1135, 4131).build()
    ...
    val GLOWSTONE = RagiMaterial.Element("glowstone", TypeRegistry.DUST, ColorUtil.mixColor(RagiColor.GOLD, RagiColor.YELLOW), 112.2f, "Gl", 1122, 1194).build()

    val ENDER = RagiMaterial.Element("ender", TypeRegistry.DUST, ColorUtil.mixColor(RagiColor.DARK_GREEN to 1, RagiColor.BLUE to 1), 112.2f, "En", 1122, 1194).build()

    //Integration
    val MITHRIL = RagiMaterial.Element("mithril", TypeRegistry.METAL, ColorUtil.mixColor(RagiColor.BLUE to 1, RagiColor.AQUA to 1), 193.7f, "Mt", 1937, 1937).build()
