...
abstract class BlockContainerBase<T : TileBase>(ID: String, material: Material, val tile: Class<T>, maxTips: Int) :
    BlockBase(ID, material, maxTips), ITileEntityProvider {
    ...
    override fun onBlockActivated(
        ...
        if (hand == EnumHand.MAIN_HAND) {
            val tile = world.getTileEntity(pos)
            return if (tile !== null && tile is TileBase) tile.onTileActivated(
                world,
                pos,
                player,
                hand,
