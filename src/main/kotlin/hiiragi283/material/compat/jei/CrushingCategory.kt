...
class CrushingCategory(guiHelper: IGuiHelper) : hiiragi283.material.compat.jei.HiiragiRecipeCategory<CrushingRecipe>(
    hiiragi283.material.compat.jei.CRUSHING, guiHelper) {
    ...
    override fun setRecipe(layout: IRecipeLayout, wrapper: CrushingRecipe, p2: IIngredients) {
        ...
        layout.itemStacks[0] = wrapper.getInput().getAllItemStack()
        //outputのスロットを登録
        (0..6).forEach {
