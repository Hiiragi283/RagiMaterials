...
fun shareOredict(oredict1: String, oredict2: String) {
    OreDictionary.getOres(oredict1)
        .filterNot { OreDictionary.containsMatch(false, OreDictionary.getOres(oredict2), it) } //重複する値を除外
        .forEach { stack -> OreDictionary.registerOre(oredict2, stack) }
    OreDictionary.getOres(oredict2)
        .filterNot { OreDictionary.containsMatch(false, OreDictionary.getOres(oredict1), it) } //重複する値を除外
