...
object MaterialElements {
    ...
    fun register(registry: IForgeRegistry<HiiragiMaterial>) {
        // --1st Period--
        registry.register(HYDROGEN)
        registry.register(HELIUM)
        // --2nd Period--
        registry.register(LITHIUM)
        registry.register(BERYLLIUM)
        registry.register(BORON)
        registry.register(CARBON)
        registry.register(NITROGEN)
        registry.register(OXYGEN)
        registry.register(FLUORINE)
        registry.register(NEON)
        // --3rd Period--
        registry.register(SODIUM)
        registry.register(MAGNESIUM)
        registry.register(ALUMINIUM)
        registry.register(SILICON)
        registry.register(PHOSPHORUS)
        registry.register(SULFUR)
        registry.register(CHLORINE)
        registry.register(ARGON)
        // --4th Period--
        registry.register(POTASSIUM)
        registry.register(CALCIUM)
        registry.register(SCANDIUM)
        registry.register(TITANIUM)
        registry.register(VANADIUM)
        registry.register(CHROMIUM)
        registry.register(MANGANESE)
        registry.register(IRON)
        registry.register(COBALT)
        registry.register(NICKEL)
        registry.register(COPPER)
        registry.register(ZINC)
        registry.register(GALLIUM)
        registry.register(GERMANIUM)
        registry.register(ARSENIC)
        registry.register(SELENIUM)
        registry.register(BROMINE)
        registry.register(KRYPTON)
        // --5th Period--
        registry.register(RUBIDIUM)
        registry.register(STRONTIUM)
        registry.register(YTTRIUM)
        registry.register(ZIRCONIUM)
        registry.register(NIOBIUM)
        registry.register(MOLYBDENUM)
        registry.register(TECHNETIUM)
        registry.register(RUTHENIUM)
        registry.register(RHODIUM)
        registry.register(PALLADIUM)
        registry.register(SILVER)
        registry.register(CADMIUM)
        registry.register(INDIUM)
        registry.register(TIN)
        registry.register(ANTIMONY)
        registry.register(TELLURIUM)
        registry.register(IODINE)
        registry.register(XENON)
        // --6th Period--
        registry.register(CAESIUM)
        registry.register(BARIUM)
        // --Lanthanides--
        if (RMConfig.MISC.lanthanoides) {
            registry.register(LANTHANUM)
            registry.register(CERIUM)
            registry.register(PRASEODYMIUM)
            registry.register(NEODYMIUM)
            registry.register(PROMETHIUM)
            registry.register(SAMARIUM)
            registry.register(EUROPIUM)
            registry.register(GADOLINIUM)
            registry.register(TERBIUM)
            registry.register(DYSPROSIUM)
            registry.register(HOLMIUM)
            registry.register(ERBIUM)
            registry.register(THULIUM)
            registry.register(YTTERBIUM)
            registry.register(LUTETIUM)
        }
        registry.register(HAFNIUM)
        registry.register(TANTALUM)
        registry.register(TUNGSTEN)
        registry.register(RHENIUM)
        registry.register(OSMIUM)
        registry.register(IRIDIUM)
        registry.register(PLATINUM)
        registry.register(GOLD)
        registry.register(MERCURY)
        registry.register(THALLIUM)
        registry.register(LEAD)
        registry.register(BISMUTH)
        registry.register(POLONIUM)
        registry.register(ASTATINE)
        registry.register(RADON)
        // --7th Period--
        registry.register(FRANCIUM)
        registry.register(RADIUM)
        // --Actinides Start--
        registry.register(ACTINIUM)
        registry.register(THORIUM)
        registry.register(PROTACTINIUM)
        registry.register(URANIUM)
        registry.register(NEPTUNIUM)
        registry.register(PLUTONIUM)
        if (RMConfig.MISC.transUran) {
            registry.register(AMERICIUM)
            registry.register(CURIUM)
            registry.register(BERKELIUM)
            registry.register(CALIFORNIUM)
            registry.register(EINSTEINIUM)
            registry.register(FERMIUM)
            registry.register(MENDELEVIUM)
            registry.register(NOBELIUM)
            registry.register(LAWRENCIUM)
            // --Actinides End--
            registry.register(RUTHERFORDIUM)
            registry.register(DUBNIUM)
            registry.register(SEABORGIUM)
            registry.register(BOHRIUM)
            registry.register(HASSIUM)
            registry.register(MEITNERIUM)
            registry.register(DARMSTADTIUM)
            registry.register(ROENTGENIUM)
            registry.register(COPERNICIUM)
            registry.register(NIHONIUM)
            registry.register(FLEROVIUM)
            registry.register(MOSCOVIUM)
            registry.register(LIVERMORIUM)
            registry.register(TENNESSINE)
            registry.register(OGANESSON)
        }
        // --Isotope--
        registry.register(DEUTERIUM)
        registry.register(TRITIUM)
        registry.register(URANIUM235)
    }
}