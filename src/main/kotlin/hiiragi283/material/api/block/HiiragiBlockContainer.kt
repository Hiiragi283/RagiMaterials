...
abstract class HiiragiBlockContainer<T : HiiragiTileEntity>(
    ...
    id: String,
    val tile: Class<T>
) : HiiragiBlock(material, modid, id), ITileEntityProvider {

    init {
        GameRegistry.registerTileEntity(tile, ResourceLocation(modid, "te_$id"))
    }

    //    Event    //

    override fun breakBlock(world: World, pos: BlockPos, state: IBlockState) {
        getTile<T>(world, pos)?.onTileRemoved(world, pos, state)
    ...
    override fun onBlockActivated(
        ...
        if (hand == EnumHand.MAIN_HAND) {
            return getTile<T>(world, pos)?.onTileActivated(
                world,
                pos,
                player,
                hand,
    ...
    override fun onBlockPlacedBy(
        ...
        getTile<T>(world, pos)?.onTilePlaced(world, pos, state, placer, stack)
    ...
    abstract class Holdable<T : HiiragiTileEntity>(material: Material, modid: String, id: String, tile: Class<T>) :
        HiiragiBlockContainer<T>(material, modid, id, tile) {
