...
object ElementRegistry {
    ...
    val CARBON = ElementBuilder(6, "carbon", TypeRegistry.METALLOID, RagiColor.mixColor(RagiColor.BLACK, RagiColor.DARK_GRAY), 12.0f, "C", null, null)
        .setTempSubl(4400) as ElementBuilder

    val NITROGEN =
        ElementBuilder(7, "nitrogen", TypeRegistry.GAS,RagiColor.AQUA,14.0f,"N",-210,-196)
    ...
    val ARSENIC = ElementBuilder(33, "arsenic", TypeRegistry.METALLOID,RagiColor.DARK_GRAY,74.9f,"As", null, null)
