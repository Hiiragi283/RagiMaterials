...
object ElementRegistryNew {
    ...
    val TITANIUM = RagiMaterial.Element("titanium", TypeRegistry.METAL, RagiColorManager.mixColor(mapOf(RagiColor.GOLD to 1, RagiColor.WHITE to 2)), 47.9f, "Ti", 1668, 3287).build()
    ...
    val RUTHENIUM = RagiMaterial.Element("ruthenium", TypeRegistry.METAL, RagiColorManager.mixColor(mapOf(RagiColor.LIGHT_PURPLE to 1, RagiColor.WHITE to 3)), 101.1f, "Ru", 2334, 4150).build()

    val RHODIUM = RagiMaterial.Element("rhodium", TypeRegistry.METAL, RagiColorManager.mixColor(mapOf(RagiColor.RED to 1, RagiColor.WHITE to 3)), 102.9f, "Rh", 1964, 3695).build()

    val PALLADIUM = RagiMaterial.Element("palladium", TypeRegistry.METAL, RagiColorManager.mixColor(mapOf(RagiColor.YELLOW to 1, RagiColor.WHITE to 3)), 106.4f, "Pa", 1555, 2963).build()

    val SILVER = RagiMaterial.Element("silver", TypeRegistry.METAL, RagiColorManager.mixColor(mapOf(RagiColor.AQUA to 1, RagiColor.WHITE to 2)), 107.9f, "Ag", 962, 2162).build()
    ...
    val OSMIUM = RagiMaterial.Element("osmium", TypeRegistry.METAL, RagiColorManager.mixColor(mapOf(RagiColor.BLUE to 1, RagiColor.WHITE to 3)), 190.2f, "Os", 3033, 5012).build()

    val IRIDIUM = RagiMaterial.Element("iridium", TypeRegistry.METAL, RagiColorManager.mixColor(mapOf(RagiColor.AQUA to 1, RagiColor.WHITE to 3)), 192.2f, "Ir", 2446, 4428).build()

    val PLATINUM = RagiMaterial.Element("platinum", TypeRegistry.METAL, RagiColorManager.mixColor(mapOf(RagiColor.GREEN to 1, RagiColor.WHITE to 3)), 195.1f, "Pt", 1768, 3825).build()
    ...
    val ENDER = RagiMaterial.Element("ender", TypeRegistry.DUST, RagiColorManager.mixColor(mapOf(RagiColor.DARK_GREEN to 1, RagiColor.BLUE to 1)), 112.2f, "En", 1122, 1194).build()

    //Integration
    val MITHRIL = RagiMaterial.Element("mithril", TypeRegistry.METAL, RagiColorManager.mixColor(mapOf(RagiColor.BLUE to 1, RagiColor.AQUA to 1)), 193.7f, "Mt", 1937, 1937).build()
