...
import hiiragi283.ragi_materials.inventory.container.ContainerLockableBase
import net.minecraft.client.gui.inventory.GuiContainer
import net.minecraft.client.renderer.GlStateManager
import net.minecraft.util.ResourceLocation

abstract class GuiLockableBase<T : TileLockableBase>(val container: ContainerLockableBase<T>) : GuiContainer(container) {
