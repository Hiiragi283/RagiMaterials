...
class BlockOreDictConvNew : BlockContainerBase("oredict_converter_new", Material.WOOD, 2) {
    ...
    override fun breakBlock(world: World, pos: BlockPos, state: IBlockState) {
        ...
        if (tile !== null && tile is TileOreDictConv) InventoryHelper.dropInventoryItems(world, pos, tile.inventory)
