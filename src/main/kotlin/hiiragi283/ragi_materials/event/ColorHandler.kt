...
class ColorHandler {
    ...
    fun colorHandler(event: ColorHandlerEvent.Item) {
        ...
        }, RagiInit.ItemBlockCrystal, RagiInit.ItemBlockMetal, RagiInit.ItemDust, RagiInit.ItemDustTiny, RagiInit.ItemCrystal, RagiInit.ItemGear, RagiInit.ItemIngot, RagiInit.ItemIngotHot, RagiInit.ItemNugget, RagiInit.ItemOre, RagiInit.ItemOreNether, RagiInit.ItemOreEnd, RagiInit.ItemPlate, RagiInit.ItemStick)
        ...
        itemColors.registerItemColorHandler(IItemColor { stack, tintIndex ->
            MaterialRegistry.SOUL_SAND.color!!.rgb
        }, RagiInit.ItemWaste)
    }
}